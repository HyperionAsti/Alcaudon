...
#ifndef _hyperion_labyrinth_alg_node_h_
#define _hyperion_labyrinth_alg_node_h_
 ...
 *
 */
class HyperionLabyrinthAlgNode : public algorithm_base::IriBaseAlgorithm<HyperionLabyrinthAlgorithm>
{
  private:
