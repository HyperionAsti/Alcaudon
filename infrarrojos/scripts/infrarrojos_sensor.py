...
from infrarrojos.msg import opticalinf

#Establecemos como entrada los pines que utilizaremos y le asignamos un peso a cada uno en función de su posicion 
_GPIO_USED=[12,16,20,21]
_GPIO_WEIGTH=[-1.5,-0.5,0.5,1.5]
GPIO.setmode(GPIO.BCM)
for i in range _GPIO_USED:
	GPIO.setup(i, GPIO.IN)


def infrarrojos_sensor():
	#Iniciamos el nodo, el tópico donde publicaremos el error obtenido y establecemos una frecuencia de 200 Hz
